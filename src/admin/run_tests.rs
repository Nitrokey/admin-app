    ...
    fn run_symm<Twi: I2CForT1, D: DelayUs<u32>, const N: usize>(
        ...
        use se05x::se05x::{
            commands::{
                ...
                CipherOneShotEncrypt, CipherUpdate, CreateCipherObject, DeleteCryptoObj,
                WriteSymmKey,
            },
    ...
    fn run_mac<Twi: I2CForT1, D: DelayUs<u32>, const N: usize>(
        ...
        use se05x::se05x::{
            commands::{
                ...
                MacOneShotGenerate, MacOneShotValidate, MacUpdate, MacValidateFinal,
                MacValidateInit, WriteSymmKey,
            },
